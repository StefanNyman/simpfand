...
unsigned short get_level(unsigned short curr_temp, int dir,
    ...
    // might want to consider changing this if chain into arrays...might be
    // worth it 2 * 128*2 = 512 bytes to allow temp of 0-127 with should be
    // plenty, x2 for dec/inc
    if (dir == INC) {
...
int main(int argc, char *argv[]) {
    ...
    if (!arg_count(argc)) return EXIT_FAILURE;
